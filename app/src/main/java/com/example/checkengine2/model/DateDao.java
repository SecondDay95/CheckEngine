...
public class DateDao {
    ...
    public List<String> getDailyTemperatureData(Integer day, Integer month, Integer year) {
    ...
    public List<String> getMonthlyTemperatureData(Integer month, Integer year) {
    ...
    public List<String> getYearlyTemperatureData(Integer year) {
    ...
    public List<String> getAllTemperatureData() {
